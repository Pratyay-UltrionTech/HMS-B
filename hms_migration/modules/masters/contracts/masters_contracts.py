"""
Target-native Pydantic contracts for Masters domain.

Matches legacy schemas_masters.py exactly to ensure 100% frontend contract parity.
"""
...
from hms_migration.modules.beds.entities.bed import WardType
