"""
DMS domain Pydantic V2 contracts (DTOs / schemas).

Conforms strictly to UltrionTech-Backend-Template conventions and 100% parity with HMS-B.
"""
...
class DmsDocumentResponse(BaseModel):
    ...
    created_at: datetime
    source: str = "dms"  # dms | medical_record | ipd_form
