...
Mounts the migrated router (modules.appointments.api.appointments_api.router)
...
from modules.appointments.api.appointments_api import router as migrated_appointments_router
