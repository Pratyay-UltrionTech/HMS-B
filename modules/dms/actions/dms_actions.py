...
from modules.clinical_records.entities.clinical_record import PatientDocumentCategory
from modules.dms.contracts.dms_contracts import (
    DmsDocumentCreate,
    DmsDocumentResponse,
    DmsPatientFile,
    DmsPatientItem,
...
from modules.dms.services.dms_service import (
    build_documents,
    build_patient_file,
    build_timeline,
    complete_file_html,
