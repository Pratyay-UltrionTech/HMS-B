...
from modules.equipment.contracts.equipment_contracts import (
    AmcUpdate,
    AssignmentCreate,
    AssignmentResponse,
    EquipCategoryCreate,
...
from modules.equipment.db.equipment_repository import EquipmentRepository
...
from modules.equipment.services.equipment_service import (
    actor_name,
    equip_to_response,
