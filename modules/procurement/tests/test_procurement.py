...
from modules.inpatient.entities.admission import Admission  # noqa: F401
...
from shared.auth import get_hospital_context, require_hospital_admin, require_hospital_user
