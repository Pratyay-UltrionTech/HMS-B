...
from modules.inventory.actions.inventory_actions import InventoryActions
from modules.inventory.contracts.inventory_contracts import ReceiveStockRequest
from modules.procurement.contracts.procurement_contracts import (
...
from modules.procurement.db.procurement_repository import ProcurementRepository
from modules.procurement.entities.procurement_entities import (
    ApprovalAction,
    ApprovalDecision,
    ApprovalEntityType,
    ApprovalThreshold,
...
class ProcurementActions:
    ...
    def get_analytics(self) -> ProcurementAnalyticsResponse:
        ...
        from modules.inventory.entities.inventory_entities import (
            ConsumableItem,
        ...
        from modules.inventory.entities.inventory_entities import CentralInventoryStock
